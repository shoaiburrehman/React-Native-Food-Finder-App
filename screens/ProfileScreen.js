...
const ProfileScreen = () => {
    ...
    const myCustomShare = async() => {
        ...
        try{
            const shareRespnse = await Share.open(shareOptions)
            ...
            <View style={styles.userInfoSection}>
                <View style={{flexDirection: 'row', marginTop: 15}}>
                    ...
                    <View style={{marginLeft: 20}}>
                        ...
                        <Caption style={styles.caption}>@xxvkhannr</Caption>
                    </View>
                </View>
            </View>
            <View style={styles.userInfoSection}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={{color:"#777777", marginLeft: 20}}>+92 307 2522920</Text>
                </View>
                <View style={styles.row}>
                    <Icon name="email" color="#777777" size={20} />
                    <Text style={{color:"#777777", marginLeft: 20}}>shoaiburrehman249@gmail.com</Text>
                </View>
            </View>
